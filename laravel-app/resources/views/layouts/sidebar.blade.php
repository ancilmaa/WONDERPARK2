            ...
            <nav class="sidebar-nav">
                ...
                @else
                    ...
                    @if (session('role') === 'admin')
                        {{-- Sales Forecast is the parent; the 3 zone pages live inside its submenu --}}
                        <div class="nav-group">
                            <div class="nav-parent-row">
                    ...
                    @else
                        {{-- Non-admin, non-cashier roles: no Sales Forecast access, so these stay as plain top-level links --}}
                        <a href="/fieldOfRides" class="{{ request()->is('fieldOfRides') ? 'active' : '' }}">
                            <i class="fa-solid fa-ferris-wheel"></i> Field of Rides
                        </a>
                        <a href="/RollerFever" class="{{ request()->is('RollerFever') ? 'active' : '' }}">
