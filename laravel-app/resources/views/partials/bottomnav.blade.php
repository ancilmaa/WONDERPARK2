{{--
    ...
    Tab order: Booking -> My Bookings -> Account (last).
    Waiver is not a nav item — it's a mandatory gate shown right after
    login/register (see WaiverController@show), before the dashboard
    chrome loads.
--}}
<nav class="bottomnav">
