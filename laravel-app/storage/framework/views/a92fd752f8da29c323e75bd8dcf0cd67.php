<?php $__env->startSection('title', 'Sales Forecast'); ?>
...
<style>
  ...
  /* ============================================================
     ...
     (shared with Zone Forecast for a consistent product feel)
     ============================================================ */
  :root{
    --fc-bg:        #F5F6FB;
    --fc-card:      #FFFFFF;
...
<div class="toolbar">
  <div>
    ...
    <h2><i class="fa-solid fa-brain"></i> Sales Forecast</h2>
...
<div class="section-card">
  ...
  <div id="tab-category" class="tab-pane">
    <div class="info-note">
      ...
      individual category — never combined into one bucket. Percentages are share of total store-wide revenue
...
<script>
  ...
  /* ── CONFIG ─────────────────────────────────────────────────── */
  const ML_API  = '<?php echo e(url("/api/ml")); ?>';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\REKS\REKS\laravel-app\resources\views/ml_forecast/ml_forecast.blade.php ENDPATH**/ ?>