...
<nav class="bottomnav">
    <div class="nav-brand" aria-hidden="true">
        <img src="<?php echo e(asset('images/wonderpark1logo.png')); ?>" alt="Wonder Park" class="nav-brand-logo">
    </div>

    <span class="nav-section-label only-desktop">My Visit</span>

    <a href="<?php echo e(route('user.booking')); ?>"
       class="bn-item <?php echo e(request()->routeIs('user.booking', 'user.booking.store') ? 'active' : ''); ?>">
        <span class="ic3">
    ...
    <a href="<?php echo e(route('user.bookings')); ?>"
       class="bn-item <?php echo e(request()->routeIs('user.bookings*') ? 'active' : ''); ?>">
        <span class="ic3">
    ...
    <a href="<?php echo e(route('user.dashboard')); ?>"
       class="bn-item <?php echo e(request()->routeIs('user.account') || request()->routeIs('user.dashboard') ? 'active' : ''); ?>">
        <span class="ic3">
    ...
    <div class="nav-foot only-desktop">
        <div class="nav-foot-user">
            <span class="nav-foot-avatar" style="--u-avatar-a:<?php echo e($u->avatar_color ?? '#FF5C85'); ?>;--u-avatar-b:<?php echo e($u->avatar_color_2 ?? '#B82850'); ?>;">
                <?php echo e(strtoupper(substr($u->name ?? 'G', 0, 1))); ?>

            </span>
            <span>
                <span class="nav-foot-name" style="display:block;"><?php echo e($u->name ?? 'Guest'); ?></span>
...
</nav><?php /**PATH C:\xampp\htdocs\WONDERPARK\WONDERPARK2\laravel-app\resources\views/partials/bottomnav.blade.php ENDPATH**/ ?>