...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Account'); ?> · WonderPark Amusement</title>
...
<div id="userView">
    <div class="app-frame">
        <?php echo $__env->make('partials.bottomnav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <div class="app-main">
            <div class="phone-head" style="display:flex;align-items:flex-start;justify-content:space-between;gap:12px;">
                <div>
                    <p><?php echo $__env->yieldContent('page-subtitle', 'Manage your account'); ?></p>
                    <h2><?php echo $__env->yieldContent('page-title', 'Account'); ?></h2>
                </div>
            ...
            <div class="app-body <?php echo $__env->yieldContent('body-class'); ?>">
...
<?php echo $__env->make('partials.ui-feedback', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\WONDERPARK\WONDERPARK2\laravel-app\resources\views/layouts/user.blade.php ENDPATH**/ ?>