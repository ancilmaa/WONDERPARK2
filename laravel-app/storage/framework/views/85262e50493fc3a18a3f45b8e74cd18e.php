...
<body>
    ...
    <div class="auth-split">
        ...
        <div class="auth-visual">
            <div class="bg-slide" data-bg="<?php echo e(asset('images/vikings.jpg')); ?>"></div>
            <div class="bg-slide" data-bg="<?php echo e(asset('images/roller-fever.jpg')); ?>"></div>
            <div class="auth-visual-content">
                <a href="<?php echo e(route('home')); ?>" class="logo">WonderPark<span class="dot">•</span>Amusement</a>
        ...
        <div class="auth-form-side" style="position:relative;">
            <a href="<?php echo e(route('home')); ?>" class="auth-back-btn">
            ...
            <div class="auth-card">
                ...
                <?php if(session('error')): ?>
                    <div class="auth-error"><?php echo e(session('error')); ?></div>
                <?php endif; ?>
                ...
                <div class="social-row">
                    <a href="<?php echo e(url('/auth/google/redirect')); ?>" class="btn-social google">
                    ...
                    <a href="<?php echo e(url('/auth/facebook/redirect')); ?>" class="btn-social facebook">
                        <svg viewBox="0 0 24 24">
                            <path fill="#1877F2"
                ...
                <p class="auth-signup">Don't have an account? <a href="<?php echo e(url('/register')); ?>">Create one</a></p>
            </div>
        </div>
        <script>
...
<?php /**PATH C:\xampp\htdocs\WONDERPARK\WONDERPARK2\laravel-app\resources\views/auth/login.blade.php ENDPATH**/ ?>