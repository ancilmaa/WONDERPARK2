...
<?php $__env->startSection('page-title', 'Review Booking'); ?>
<?php $__env->startSection('page-subtitle', 'Confirm the details below before payment'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="u-card">
        <h4><?php echo e($booking['package']); ?></h4>
        <p><?php echo e($booking['date']); ?> &middot; <?php echo e($booking['pax']); ?> pax</p>
    </div>
    ...
    <form method="POST" action="<?php echo e(route('user.bookings.payment', $booking['id'])); ?>" enctype="multipart/form-data" id="paymentForm">
        <?php echo csrf_field(); ?>
        ...
        <div id="qrphPanel" class="u-card" style="margin-top:14px;display:none;">
            ...
            <div style="text-align:center;margin:14px 0 4px;">
                <img src="<?php echo e(asset('images/qrph.png')); ?>" alt="QR Ph code" style="max-width:220px;width:100%;border-radius:12px;">
            </div>
    ...
    <a href="<?php echo e(route('user.bookings')); ?>" class="u-btn ghost" style="margin-top:10px;display:block;text-align:center;">
        Back to My Bookings
    </a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\REKS\REKS\laravel-app\resources\views/user/booking-review.blade.php ENDPATH**/ ?>