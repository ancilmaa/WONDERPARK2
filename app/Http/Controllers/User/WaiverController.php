...
class WaiverController extends Controller
{
    ...
    protected array $waivers = [
        ...
        'field_of_rides' => [
            'park_name' => 'Field of Rides',
            'intro' => 'In consideration for being permitted to enter the Field of Rides area, (hereinafter referred to as the "Park"), the undersigned, on behalf of themselves and any minors under their supervision, hereby acknowledges and agrees as follows:',
            'sections' => [
                ['title' => '1. Assumption of Risks', 'body' => 'The undersigned acknowledges and understands that riding the Park\'s attractions involves inherent risks, including but not limited to, the risk of injury or harm, and hereby assumes all such risks.'],
                ['title' => '2. Release and Waiver', 'body' => 'The undersigned, on behalf of themselves and any minors under their supervision, hereby releases, waives, discharges, and covenants not to sue the Park, its owners, employees, agents, and representatives (hereinafter collectively referred to as the "Released Parties") from any and all liability, claims, demands, actions, and causes of action whatsoever arising out of or related to any loss, damage, or injury, including death, that may be sustained by the undersigned or any minor under their supervision while in or upon the Park premises.'],
                ['title' => '3. Height and Health Requirements', 'body' => 'A minimum height requirement applies per ride, as posted at each attraction. Guests under 4 feet must be accompanied by a paying guardian; chaperone-only riders are not permitted. Riders must be free from motion sickness, heart conditions, or other health restrictions listed at the ticket booth, and the undersigned confirms that they and any minors under their supervision meet these requirements.'],
                ['title' => '4. Responsibility for Minors', 'body' => 'The undersigned acknowledges and agrees that they are responsible for the supervision and actions of any minors under their care or supervision while in or upon the Park premises.'],
                ['title' => '5. Lost, Stolen, or Damaged Belongings', 'body' => 'The undersigned acknowledges and agrees that the Park shall not be responsible for any lost, stolen, or damaged belongings while in or upon the Park premises.'],
                ['title' => '6. Damages to Park Property', 'body' => 'The undersigned agrees to be held financially responsible for any damages caused by themselves or any minors under their supervision to any equipment or facility within the Park, based on the value of the equipment or facility and the extent of the damages incurred.'],
                ['title' => '7. Right to Refuse Service', 'body' => 'Management reserves the right to refuse service to guests who do not follow posted safety guidelines.'],
                ['title' => '8. Full Extent of Philippine Law', 'body' => 'The undersigned agrees that this agreement shall be enforced to the fullest extent permitted by Philippine law.'],
            ],
        ],
    ];
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        // Payment already confirmed the booking, so send the customer to
        // their receipt (with the voucher code) instead of just the list.
        $bookingId = session('booking_id');

        if ($bookingId) {
            return redirect()
                ->route('user.bookings.receipt', $bookingId)
                ->with('success', 'Waiver signed. Here is your booking receipt!');
        }
